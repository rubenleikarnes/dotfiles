...
elif [ "$DATAFOLDER" = '.vscode-insiders' ]; then
    # remove this once microsoft/vscode@d9f91002d40deaf45aefee9563cb8096aea7a23b is in (insiders 1.64)
	DATAFOLDER='.vscode-server-insiders'
fi
